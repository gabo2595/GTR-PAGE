					...
					<BarDiv className="bar">
						<BarWrap className="bar-wrap">
							<LinksDiv className="links"> {/* footer menu */}
								...
								<li><Link style={{textDecoration: 'none', cursor: 'pointer', WebkitTransition: 'all .3s linear', MozTransition: 'all .3s linear', MsTransition: 'all .3s linear', OTransition:  'all .3s linear', transition: 'all .3s linear'}} activeClass="active" to="test1" spy={true} smooth={true} offset={0} duration={1300} delay={200}>Acerca de mi</Link></li>
							...
							<Social className="social">
								...
								<A target="_blank" href="https://www.linkedin.com/in/gabriel-torres-268519126" className="rss">
									<SpanIcon id="icon" className="fa fa-linkedin-square"></SpanIcon>
								...
								<A target="_blank" href="https://www.facebook.com/gabriel.torres.52459" className="fb">
									<SpanIcon id="icon" className="fa fa-facebook-square"></SpanIcon>
									<SpanInfo className="info">
										<SpanFollow className="follow">Facebook</SpanFollow>
									</SpanInfo>
								</A>
								<A target="_blank" href="#" className="tw">
									<SpanIcon id="icon" className="fa fa-twitter-square"></SpanIcon>
									<SpanInfo className="info">
